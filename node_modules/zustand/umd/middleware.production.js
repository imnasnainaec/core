!(function (t, e) {
  ...
  var r = function (t, n) {
    ...
    u = function (t) {
      ...
      return e
        ? Object.fromEntries(
            Object.entries(e.stores).map(function (t) {
          ...
          l.setState = function (t, n, r) {
            ...
            return void 0 === g
              ...
              : (null == S ||
                  S.send(
                    e({}, a, { type: g + '/' + a.type }),
                    e({}, u(m.name), (((i = {})[g] = l.getState()), i))
                  ),
                o);
          };
          var w = function () {
              var t = O;
              (O = !1), s.apply(void 0, arguments), (O = t);
            },
            I = t(l.setState, f, l);
          if (
            ('untracked' === b.type
              ...
              : ((b.stores[b.store] = l),
                null == S ||
                  S.init(
                    Object.fromEntries(
                      Object.entries(b.stores).map(function (t) {
                        var e = t[0],
                          n = t[1];
  ...
  function l(t, e) {
    ...
    return {
      ...
      setItem: function (t, r) {
        return n.setItem(t, JSON.stringify(r, null == e ? void 0 : e.replacer));
      },
  ...
  var d = function t(e) {
    ...
    v = function (t, n) {
      return 'getStorage' in n || 'serialize' in n || 'deserialize' in n
        ? (function (t, n) {
            return function (r, i, o) {
              var a,
                u = e(
                  ...
                  if (f) {
                    (u = !1),
                      s.forEach(function (t) {
                        var e;
                        return t(null != (e = i()) ? e : g);
                      });
                    var e =
                      (null == a.onRehydrateStorage
                        ? void 0
                        : a.onRehydrateStorage(null != (t = i()) ? t : g)) ||
                      void 0;
