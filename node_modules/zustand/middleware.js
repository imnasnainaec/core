...
var getTrackedConnectionState = function getTrackedConnectionState(name) {
  ...
  return Object.fromEntries(
    Object.entries(api.stores).map(function (_ref) {
      var key = _ref[0],
        api = _ref[1];
  ...
  return function (set, get, api) {
    ...
    if (connectionInformation.type === 'untracked') {
      ...
      connection == null
        ...
        : connection.init(
            Object.fromEntries(
              Object.entries(connectionInformation.stores).map(function (
                _ref2
              ) {
                var key = _ref2[0],
                  store = _ref2[1];
    ...
    api.persist = {
      ...
      clearStorage: function clearStorage() {
        ...
        (_storage = storage) == null
          ? void 0
          : _storage.removeItem(options.name);
      },
...
var newImpl = function newImpl(config, baseOptions) {
  return function (set, get, api) {
    ...
    api.persist = {
      ...
      clearStorage: function clearStorage() {
        var _storage2;
        (_storage2 = storage) == null
          ? void 0
          : _storage2.removeItem(options.name);
      },
      getOptions: function getOptions() {
        return options;
      },
